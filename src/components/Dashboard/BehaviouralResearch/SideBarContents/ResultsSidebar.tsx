...
const stages = [
    { id: 1, label: 'Resumen', icon: <InsertDriveFileIcon /> },
    { id: 2, label: 'Implicit Association', icon: <LanIcon /> },
    { id: 1, label: 'Cognitive task', icon: <InsertDriveFileIcon /> },
    { id: 2, label: 'Eye Tracking', icon: <LanIcon /> },
];
