...
export function AddQuestionSection() {
  ...
  return (
    <Box sx={{ backgroundColor: '#F3F6FC', borderRadius: 2, width: 845, height: `${ displayQuestions ? '381' : 'auto'}`, border: `1px solid ${grey[300]}`, }}>
      ...
      <Box sx={{ p: 3 }}>
        ...
        >
          ...
          <FormControlLabel
            control={<Checkbox onChange={() => setDisplayQuestions(!displayQuestions)} color="primary" />}
