import { Box, FormControl, FormControlLabel, MenuItem, Select, SelectChangeEvent, Typography } from "@mui/material";
import { useState } from "react";
import { AntSwitch } from "../Switch";

export function CustomerEffortScoreQuestion({ title }: { title: string }) {
