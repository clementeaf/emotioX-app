...
import RatingStep, { FinishStep, GenderStep, InstructionsStep, OptionsStep, ProblemSolveStep, SelectCityStep, SocialMediaStep, TestAppNavigationStep, TestAppNavigationStepV2, WelcomeStep } from './CognitiveSteps';
