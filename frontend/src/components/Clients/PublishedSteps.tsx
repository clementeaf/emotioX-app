import { Box, Button, Checkbox, FormControl, FormControlLabel, FormGroup, Rating, Stack, TextField, Typography } from '@mui/material';
    ...
    return (
        <StepsCommonGrid>
            <Box
                ...
                width={400}
            >
                <Typography gutterBottom width={360} height={52} fontWeight={400} fontSize={20} lineHeight="26px" color="#262626" textAlign='start'>
